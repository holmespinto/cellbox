...
const OrdenarTaller = React.lazy(() => import('../pages/dashboard/Taller/OrdenarTaller'));
const Tecnicos = React.lazy(() => import('../pages/dashboard/Taller/Tecnicos'));
...
const dashboardRoutes = {
    ...
    children: [
        ...
        {
            path: '/dashboard/taller/ordenartaller',
            name: 'OrdenarTaller',
            component: OrdenarTaller,
            route: PrivateRoute,
        },
        
        {
            path: '/dashboard/taller/tecnicos',
            name: 'Tecnicos',
            component: Tecnicos,
            route: PrivateRoute,
        },
